...
short RowSumArray(int array[100][100], int sumArray[100], short Rows, short Cols)
{
    for (int i = 0; i < Rows; i++)
    {
...
void PrintRowSumArray(int array[100], short Rows)
{
    for (int i = 0; i < Rows; i++)
    {
        //array[i][0]+array[i][1]+array[i][2]
...
int main()
{
    ...
    RowSumArray(array, sumArray, Rows, Cols);
    PrintRowSumArray(sumArray, Rows);

    PrintArray(sumArray, Cols);
